 ...
 * It has been modified to add a mark() method that saves the current
 ...
 *
 * Copied from Couchbase Elasticsearch Connector 4.0.
 * The code agrees with the following file in the release/4.0 tag:
 * https://raw.githubusercontent.com/couchbase/couchbase-elasticsearch-connector
 * /release/4.0/src/main/java/com/couchbase/connector/dcp/MarkableCrc32.java
 * <p>
 ...
 * @since 1.11
 */
public class MarkableCrc32 implements Checksum {

  /** the current CRC value, bit-flipped */
  private int crc = 0xffffffff;
  private int mark = crc;
